...
if (manifest.schemaVersion !== 'tutti.agent.manifest.v2' || manifest.agentKey !== 'kimi-code' || manifest.version !== '1.0.1') throw new Error('invalid manifest identity');
...
const expectedCapabilities = { imageInput: true, audioInput: false, embeddedContext: true, interrupt: true, resume: true, permissionModes: true, modelSelection: true, commands: true, skills: false };
